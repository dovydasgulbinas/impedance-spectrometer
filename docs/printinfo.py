# printinfo.py - for LibTiePie 0.5+
#
...
def print_generator_info(gen):
    ...
    if (gen.signal_type & STM_AMPLITUDE) != 0:
    ...
    if (gen.signal_type & STM_FREQUENCY) != 0:
