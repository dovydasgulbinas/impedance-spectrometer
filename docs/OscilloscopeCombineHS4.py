# OscilloscopeCombineHS4.py - for LibTiePie 0.5+
#
...
allowedProductIDs = [libtiepie.PID_HS4, libtiepie.PID_HS4D]
scps = []
...
if len(scps) > 1:
    ...
    print('Not enough HS4(D)\'s found (' + str(len(scps)) + '), at least two required!')
    sys.exit(1)
