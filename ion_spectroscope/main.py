...
class DataSignals(QtCore.QObject):
    ...
    def value_generator(self, value):
...
class MainWindow(QtGui.QMainWindow, spectro_gui.Ui_MainWindow):
    def __init__(self):
        ...
        # this method will get a emited signal value 
    ...
    def handle_value_updated(self, value): # you must pass value
        ...
        QtGui.qApp.processEvents() # force complete redraw for every lot
...
if __name__ == "__main__":
    ...
    window = MainWindow()
    window.show()
    # I must call value generator method and pass data to it  
